      ...
      <div ref={scope}>
        ...
        <section className="section-pad" data-sp-section style={{ background: 'var(--white)' }}>
          <div className="container">
            ...
            <div className="sp-anim" style={{ marginTop: '2rem' }}>
              <div
                style={{
                  display: 'grid',
              ...
              >
                <div className="sp-card" style={{ padding: '2.5rem', background: 'var(--bg-light)', borderRadius: '16px' }}>
                  <h3 style={{ fontFamily: 'var(--font-sans)', fontSize: '1.25rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.02em', marginBottom: '1rem', color: 'var(--ink)' }}>
                    01. Quotations & Contracts
                  </h3>
            ...
            <div className="sp-anim" style={{ marginTop: '2.5rem' }}>
              <h4 style={{ fontFamily: 'var(--font-sans)', fontSize: '0.9375rem', fontWeight: 800, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--burg-primary)', marginBottom: '1rem' }}>
                Standing Commercial Parameters
              </h4>
              <SpecRows
        ...
        <section className="section-pad sp-dark" data-sp-section>
          <div className="container">
            ...
            <div className="sp-anim" style={{ marginTop: '2.5rem' }}>
              ...
              >
                <div style={{ padding: '2rem', border: '1px solid rgba(255, 255, 255, 0.12)', borderRadius: '16px', background: 'rgba(255, 255, 255, 0.03)' }}>
                  <span style={{ fontSize: '0.8125rem', fontWeight: 800, color: 'var(--burg-primary)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                    Packaging Integrity
                  </span>
                  <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: '#FFFFFF', margin: '0.75rem 0 1rem' }}>
                    High-Density Moisture Baling
                  </h3>
                  <p className="sp-body" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>
                ...
                <div style={{ padding: '2rem', border: '1px solid rgba(255, 255, 255, 0.12)', borderRadius: '16px', background: 'rgba(255, 255, 255, 0.03)' }}>
                  ...
                  <p className="sp-body" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>
                    Full Container Load (FCL 20ft & 40ft HC) loading is executed directly on plant ramps in Faisalabad and coordinated via dry port or bonded road transit to Karachi Sea Ports (Karachi Port / Port Qasim) for global ocean export.
                  </p>
                </div>
        ...
        <section className="section-pad" data-sp-section style={{ background: 'var(--white)' }}>
          <div className="container">
            ...
            <div className="sp-anim" style={{ marginTop: '2.5rem' }}>
              ...
              >
                <div style={{ padding: '2.5rem', border: '1px solid var(--border-light)', borderRadius: '16px', background: 'var(--white)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                    <span style={{ fontSize: '1.5rem' }}>©</span>
                    <h3 style={{ fontFamily: 'var(--font-sans)', fontSize: '1.25rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.02em', color: 'var(--ink)' }}>
                      Copyright Ownership
                    </h3>
                  </div>
