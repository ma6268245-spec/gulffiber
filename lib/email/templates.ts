...
/* ---- Brand tokens: taken from app/globals.css and the Gulf Fibre logo ---- */
const NAVY = '#0A1128' // --ink
const NAVY_DEEP = '#071738' // --burg-dark, the footer
const BLUE = '#0A4BB8' // --burg-primary, Gulf Fibre blue
...
const COMPANY = 'Gulf Fibre Company (Pvt) Limited'
const BRAND_LINE = 'Pioneers of Regenerated Polyester Fibre in Pakistan'
const PHONES = [
          ...
          <td class="px" style="padding:28px 28px 6px;background:#FFFFFF;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
              <td style="border-top:1px solid ${BORDER};padding-top:22px;">
                ...
                <p style="margin:0 0 3px;font-family:${F};font-size:15px;font-weight:700;line-height:1.5;color:${BLUE};">Gulf Fibre Team</p>
...
function shell(o: { title: string; preheader: string; origin: string; body: string }) {
...
<body style="margin:0;padding:0;background:${PAGE_BG};">
  <div style="display:none;font-size:1px;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;mso-hide:all;">${o.preheader}</div>
...
const VALUE_POINTS: { glyph: string; title: string; copy: string; green?: boolean }[] = [
  {
    ...
    copy: 'Stay informed with the latest in polyester fibre and textile innovation.',
  },
  {
    glyph: '&#10003;',
  ...
  },
  {
    ...
    copy: 'High-performance fibre solutions for diverse industrial applications.',
  },
  {
    glyph: '&#10054;',
...
export function newsletterSubscriptionEmail({ origin }: { origin: string }): NewsletterEmail {
          ...
          <td class="px" style="padding:30px 28px 0;background:#FFFFFF;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:${TINT};border:1px solid ${BORDER};border-radius:14px;"><tr>
              <td align="center" style="padding:38px 30px 34px;">
                ...
                ${greenRule()}
                <p style="margin:22px 0 12px;font-family:${F};font-size:15px;font-weight:600;line-height:1.6;color:${NAVY};">Thank you for subscribing to Gulf Fibre updates.</p>
  ...
  const html = shell({
    title: "You're Subscribed — Gulf Fibre",
    preheader: 'You are on the Gulf Fibre updates list — news, products, certifications and industry insights.',
    origin,
    body,
  })
...
Thank you for subscribing to Gulf Fibre updates.
...
Industry Updates
Stay informed with the latest in polyester fibre and textile innovation.

Quality You Can Trust
ISO 9001:2015 certified processes ensuring premium quality.

Innovative Solutions
High-performance fibre solutions for diverse industrial applications.
...
(c) ${COMPANY}. All Rights Reserved.`
  ...
  return { subject: 'Thanks for subscribing to Gulf Fibre updates', html, text }
}
...
export function contactAcknowledgementEmail({ origin }: { origin: string }): ContactEmail {
              ...
              <td style="padding:24px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
                  <td class="photocell" width="176" valign="top" style="width:176px;padding-right:22px;">
                    <img class="photo" src="${origin}/images/process-fibre.jpg" width="176" height="236" alt="Polyester fibre extrusion line at the Gulf Fibre plant" style="display:block;width:176px;height:236px;border:0;outline:none;border-radius:10px;" />
                  </td>
                  <td class="photocopy" valign="middle">
                    ...
                    <p style="margin:0 0 22px;font-family:${F};font-size:13.5px;line-height:1.7;color:${TEXT};">Discover our range of polyester fibre products and technical capabilities.</p>
  ...
  const html = shell({
    title: 'Thank You for Reaching Out — Gulf Fibre',
...
Discover our range of polyester fibre products and technical capabilities.
...
(c) ${COMPANY}. All Rights Reserved.`
  ...
  return { subject: 'Thank you for reaching out to Gulf Fibre', html, text }
}
